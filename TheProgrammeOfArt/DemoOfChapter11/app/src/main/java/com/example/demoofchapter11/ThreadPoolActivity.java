...
public class ThreadPoolActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void initViews() {
        ...
        tv_name1 =  findViewById(R.id.progress_bar1).findViewById(R.id.tv_name);
        tv_name2 =  findViewById(R.id.progress_bar2).findViewById(R.id.tv_name);
        tv_name3 =  findViewById(R.id.progress_bar3).findViewById(R.id.tv_name);
        tv_name4 =  findViewById(R.id.progress_bar4).findViewById(R.id.tv_name);
        tv_name5 =  findViewById(R.id.progress_bar5).findViewById(R.id.tv_name);
        ...
        init();
        tv_thread1 =  findViewById(R.id.tv_thread1);
        tv_thread2 =  findViewById(R.id.tv_thread2);
        tv_thread3 =  findViewById(R.id.tv_thread3);
        tv_thread4 =  findViewById(R.id.tv_thread4);
        tv_thread5 =  findViewById(R.id.tv_thread5);
        tv_thread_all =  findViewById(R.id.tv_thread_all);
        tv_pool_type =  findViewById(R.id.tv_pool_type);
        tv_stop1 =  findViewById(R.id.tv_stop1);
        tv_stop2 =  findViewById(R.id.tv_stop2);
        tv_stop3 =  findViewById(R.id.tv_stop3);
        tv_stop4 =  findViewById(R.id.tv_stop4);
        tv_stop5 =  findViewById(R.id.tv_stop5);
        tv_stop_all =  findViewById(R.id.tv_stop_all);
        tv_shutdown =  findViewById(R.id.tv_shutdown);
        tv_shutdownNow =  findViewById(R.id.tv_shutdown_now);
