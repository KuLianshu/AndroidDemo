...
@Route(path = Constants.PATH_INNER_MODULE)
class InnerModuleARouterTestActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_inner_module_arouter_test)
        ...
        button.setOnClickListener {
            setResult(200, Intent().putExtra("id",400))
            finish()
        }
